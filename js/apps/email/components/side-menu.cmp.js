export default {
    ...
    <div class="side-menu">
        ...
        <ul class="side-menu-list">
            ...
            <li :class="{active : active === 'drafts' ,  bold : unread && active === 'draft' }" class="side-menu-item" @click="onDirClick('drafts')"><i class="fa fa-sticky-note"></i> Drafts <span v-if="unread && active === 'drafts'">({{ unread }})</span></li>
